...
// //shape
// const sphereShape = new CANNON.Sphere(0.5) //0.5 is the radius, same radius with our threejs sphere radius
// const sphereBody = new CANNON.Body({
//     mass:1, //if you have two bodies and they collide, the one with the bigger mass pushes the other
...
// floorBody.mass // this object is static and won't move because of mass 0
...
const tick = () =>
{
    ...
    for(const obj of objectsToUpate){
        const { mesh, body } = obj
