...
import { useGLTF, OrbitControls, Instance } from "@react-three/drei";
  ...
  return (
    <>
      ...
      <Physics debug={false} gravity={[0, -9.81, 0]}>
        <RigidBody colliders="ball" gravityScale={1} restitution={0}>
        ...
        <RigidBody
          ref={cube}
          position={[1.5, 2, 0]}
          friction={0.7} // that's the default friction
          colliders={false}
          onCollisionEnter={collisionEnter}
          // onCollisionExit={() => console.log("exit")}
          // onSleep={() => console.log("sleeping")}
          // onWake={() => console.log("woken")}
        >
